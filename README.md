...
* Просмотр товара и добавление в корзину (рядом с каждой позицией должна быть кнопка добавления в корзину). Товар можно добавить из подборки, со страницы категории или со страницы товара.
...
* Для добавления товара в корзину нужно авторизоваться. Пользователя автоматически перекидывает на нужную страницу. При необходимости можно зарегистрироваться.
